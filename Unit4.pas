...
var Told,d_phi_T :double;
begin
  Told:=NP0.Temperature;
  NP0.Temperature:=Form4.DDSpinEdit46.Value+273;
  { Temperature changes NP0.gL }
  d_phi_T   :=step(2.3,(NP0.Temperature-Told)/10);
  Form4.DDSpinEdit12.Value:=Form4.DDSpinEdit12.Value*d_phi_T;
end;
...
begin
  ...
  0: begin
       Form4.PageControl1.Left:=294;
       Form4.PageControl1.Top:=68;
       Form11.Top:=530;
       Form12.Top:=29;
       Form5.Top:=241;
     end;
...
begin
  NoiseP.Ampl:=Form4.DDSpinEdit54.Value/(NP0.Square*1e9);
end;

procedure TForm4.DDSpinEdit55Change(Sender: TObject);
begin
  NoiseP.tau:=Form4.DDSpinEdit55.Value/1e3; {s}
end;

procedure TForm4.DDSpinEdit56Change(Sender: TObject);
begin
  NP0.gLd:=Form4.DDSpinEdit56.Value; {mS/cm^2}
end;

procedure TForm4.DDSpinEdit57Change(Sender: TObject);
begin
  NP0.VLd:=Form4.DDSpinEdit57.Value/1000; {V}
end;

procedure TForm4.DDSpinEdit58Change(Sender: TObject);
begin
  NP0.l:=Form4.DDSpinEdit58.Value;
end;
...
begin
  ...
  NP0.Thr_type:=Form4.ComboBox5.Items[Form4.ComboBox5.ItemIndex];
end;

procedure TForm4.SpinEdit1DblClick(Sender: TObject);
begin
  Form4.SpinEdit1.Value:=1;
end;

procedure TForm4.SpinEdit2DblClick(Sender: TObject);
begin
  Form4.SpinEdit2.Value:=1;
end;

procedure TForm4.DDSpinEdit59Change(Sender: TObject);
begin
  NP0.DepBlock_limit:=Form4.DDSpinEdit59.Value;
end;

procedure TForm4.ComboBox5DblClick(Sender: TObject);
begin
  Form4.ComboBox5.ItemIndex:=3;
  NP0.Thr_type:=Form4.ComboBox5.Items[Form4.ComboBox5.ItemIndex];
end;

procedure TForm4.DDSpinEdit60Change(Sender: TObject);
begin
  NP0.Mg:=Form4.DDSpinEdit60.Value; {mM}
end;
