object Form1: TForm1
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet2: TTabSheet
      ...
      object Chart4: TChart
        ...
        object Series27: TLineSeries
          ...
          Title = 'XNa[13]'
          OnDblClick = Series27DblClick
          LinePen.Width = 2
          Pointer.Brush.Color = 16744576
          Pointer.HorizSize = 2
          Pointer.InflateMargins = True
          Pointer.Pen.Color = 16711808
          Pointer.Style = psCircle
          Pointer.VertSize = 2
          Pointer.Visible = True
          XValues.DateTime = False
    ...
    object TabSheet3: TTabSheet
      ...
      object Chart3: TChart
        ...
        Title.Visible = False
        BottomAxis.Title.Caption = 'ms'
        LeftAxis.Title.Caption = 'Model'#39's units'
        Legend.Alignment = laTop
        ...
        Legend.ShadowSize = 0
        Legend.VertMargin = 5
        RightAxis.Title.Caption = 'Experiment'#39's units'
        View3D = False
        Color = clMoneyGreen
        TabOrder = 0
    ...
    object TabSheet6: TTabSheet
      ...
      object Chart6: TChart
        ...
        LeftAxis.Title.Caption = 'dVdt, mV/ms'
      ...
      object Chart7: TChart
        ...
        Title.Font.Style = []
        Title.Text.Strings = (
          'Dynamic I-V-function')
        BottomAxis.Title.Caption = 'V, mV'
        LeftAxis.Title.Caption = 'Im, mV/ms'
        Legend.Visible = False
        View3D = False
        Color = clMoneyGreen
        TabOrder = 1
  ...
  object MainMenu1: TMainMenu
    ...
    object aaa1: TMenuItem
      ...
      object rampid1: TMenuItem
        Caption = #39'ramp.id'#39
        GroupIndex = 17
        OnClick = rampid1Click
      end
      object VCstepsid1: TMenuItem
        Caption = #39'VC_steps.id'#39
        GroupIndex = 17
        OnClick = VCstepsid1Click
      end
    ...
    object Parameters: TMenuItem
      ...
      object VoltageClamp1: TMenuItem
        ...
        object VCatVexp1: TMenuItem
          Caption = 'VC at Vexp'
          GroupIndex = 11
          RadioItem = True
          OnClick = VCatVexp1Click
        end
        object VCwithpipette1: TMenuItem
          Caption = 'VC with pipette'
          GroupIndex = 11
          RadioItem = True
          OnClick = VCwithpipette1Click
        end
      end
      object N7: TMenuItem
        Caption = '-'
      ...
      object HHtype2: TMenuItem
        ...
        object White21: TMenuItem
          Caption = 'White2'
          GroupIndex = 12
          RadioItem = True
          OnClick = White21Click
        end
        ...
        object Bazhenov1: TMenuItem
          Caption = 'Bazhenov'
          GroupIndex = 12
          OnClick = Bazhenov1Click
        end
      end
      object HHorder1: TMenuItem
        ...
        object N2pMainenSejn1: TMenuItem
          Caption = '2-p-MainenSejn'
          GroupIndex = 28
          OnClick = N2pMainenSejn1Click
        end
        object N2pActiveDend1: TMenuItem
          Caption = '2-p-ActiveDend'
          GroupIndex = 28
          OnClick = N2pActiveDend1Click
        end
      end
      object N9: TMenuItem
        Caption = '-'
      ...
      object Setexpdatafile1: TMenuItem
        Caption = 'Set exp. data file'
        GroupIndex = 112
        OnClick = Setexpdatafile1Click
      end
      object N6: TMenuItem
        Caption = '-'
        GroupIndex = 112
    ...
    object asks1: TMenuItem
      Caption = 'Tasks'
      object Simplex2: TMenuItem
        Caption = 'Simplex'
        OnClick = Simplex2Click
      end
      object FiringClampandPRC1: TMenuItem
        Caption = 'Firing-Clamp and PRC'
        OnClick = FiringClampandPRC1Click
      end
      object ActInact1: TMenuItem
        Caption = 'Act/Inact'
        OnClick = ActInact1Click
      end
    end
    ...
    object About1: TMenuItem
      Caption = 'About'
      object heprogramhasbeenwrittenbyAntonVChizhovforComputationalPhysicsLaboratorypurposes1: TMenuItem
        Caption = 
          'The program has been written by Anton V. Chizhov for the needs o' +
          'f Computational Physics Laboratory of the Ioffe Institute of RAS' +
          '. '
      end
    end
  end
