...
begin
  ...
  str(Space.Gs_R:8:3,t1);
  Form12.Label2.Caption:='1/ro_inf=Gs_R='+t1;
  Form12.Label3.Caption:='ri='+IntToStr(round(Space.ri))+' kOhm/cm';
  str(Tanh(Space.L/Space.lamda)/Space.Gs_R:8:5,t1);
  Form12.Label12.Caption:='ro='+t1;
...
begin
  ...
  REPEAT  nt:=nt+1;  { time step }
    ...
    case NP0.If_I_V_or_g of
      ...
      6: Vr:=AFiber.Nrn[iz_Draw].NV.Iind;{pA}
      7: Vr:=AFiber.Nrn[iz_Draw].NV.V - AFiber.Nrn[iz_Draw].NP.Vrest;
    end;
