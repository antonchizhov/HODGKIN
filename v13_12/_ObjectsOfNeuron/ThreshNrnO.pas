...
//     ConditionsAtSpike(sinceAP);
  ...
  { Brette threshold equation }
//  if NP.IfBretteThreshold=1 then NV.Thr:=VThreshold6(NP,NV);
  if NP.IfBretteThreshold=1 then NV.Thr:=VThreshold7(NP,NV); {introduced on 20.06.2011}
