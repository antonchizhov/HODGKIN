...
//  tIfSpikeOccursInThrModel = procedure(V_,Thr,ddV:double; var tAP_:double; var indic_:integer);
  ...
  NeuronProperties =record
    HH_type,HH_order,Na_type,Na_subtype,NaR_type,NaR_subtype
                                                            :string;
    ...
    IfReduced,IfThrModel,IfLIF,IfBretteThreshold, IfSpikeDependentEIF,
    ...
    gL,VL,Square,tau_m0,ro,l,Vrest,C_membr,
    gNa,gNaR,gK,gKM,gKA,gKD,gCaH,gKCa,gADP,gAHP,gCaT,gBst,gNaP,gH,
    VNa,VNaR,VK,VKDr,VKM,VKD,V12H,VADP,VCa,
...
//    VThreshold2                                             :tVThreshold2;
  ...
  NeuronVariables =record
    ...
    V,gActive,Ca,Vold,Im,PSC,Isyn,IsynE,IsynI,IsynE_old,IsynI_old,IatE,
    gNMDA,
    VatE,DVDt,ddV,Thr,tAP,ISI0,
