...
type
  TForm1 = class(TForm)
    ...
    procedure Currentclamp1Click(Sender: TObject);
    ...
    procedure ActInactButtonClick(Sender: TObject);
...
uses MathMyO,Other,Graph,Coeff,Hodgkin,SetNrnParsO,Clamp,Simplex,
     ...
     Unit14, Unit15, Unit16, Unit17, Unit18, Unit31;
...
procedure TForm1.ActInactButtonClick(Sender: TObject);
begin
  Form2.Visible:=true;
end;
...
procedure TForm1.Currentclamp1Click(Sender: TObject);
begin
  NP0.If_I_V_or_g:=2;
  CorrespondParametersToTheForm;
end;
