...
begin
  ...
  if NP0.If_I_V_or_g=2 then begin
...
begin
  case Form1.RadioGroup1.ItemIndex of
   ...
   34: DefineAskedCurve:=NV0.VatE*1000;
...
begin
  ...
  NP0.If_I_V_or_g:=2;  { 1-VC; 2-CC; 3-measure g; 4-VC with pipette; 5-VC with Vh=Vexp }
...
procedure InitialConditions;
begin
  NV0.V:=NP0.Vrest;  NV0.VatE:=NP0.Vrest; NV0.IsynE_old:=0;
  du_Reset:=0{mA/cm^2};
  DispV:=0;  NV0.Thr:=100;
  t:=0;   nt:=0;
