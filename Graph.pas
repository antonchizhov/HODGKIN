...
var     xU,tl,minSc,maxSc       :double;
        nl,nle,ntl              :integer;
begin
  Form1.Series9.Active:=(NP0.HH_order='2-points')or
                        (NP0.HH_order='2-p-MainenSejn')or
...
begin
      ...
      Form1.Series9.AddXY(t*1000,NV0.Vd*1000);
      ...
      if NP0.Na_type='Lyle' then begin        // it was ANrn.NP and ANrn.NV before 25.02.2017
         Form1.Series22.AddXY(t*1000,NV0.XNa[1]);
         Form1.Series23.AddXY(t*1000,NV0.XNa[2]);
         Form1.Series24.AddXY(t*1000,NV0.XNa[3]);
         Form1.Series25.AddXY(t*1000,NV0.XNa[4]);
         Form1.Series27.AddXY(t*1000,NV0.XNa[13]);
      end;
      { Phase plane}
