...
//  writeln(vvv,
    ...
    ss,i);BlockWrite(b,uu,i);BlockWrite(b,NP0.gNa,i);BlockWrite(b,NP0.gL,i);BlockWrite(b,NP0.VL,i);BlockWrite(b, NP0.Square,i);BlockWrite(b, NP0.tau_m0,i);BlockWrite(b,NP0.ro,i);BlockWrite(b,NP0.l,i);BlockWrite(b,NP0.Vrest,i);BlockWrite(b,
    NV0.V,i);BlockWrite(b,NV0.Im,i);BlockWrite(b,NV0.IsynE,i);BlockWrite(b,NV0.IsynI,i);BlockWrite(b,NV0.IsynE_old,i);BlockWrite(b,NV0.Vd,i);
//                                                            :vect2;
  writeln(vvv,
    NV0.gActive,' ',
...
//  Readln(vvv,
    ...
    ss,i);BlockRead(b,uu,i);BlockRead(b,NP0.gNa,i);BlockRead(b,NP0.gL,i);BlockRead(b,NP0.VL,i);BlockRead(b, NP0.Square,i);BlockRead(b, NP0.tau_m0,i);BlockRead(b,NP0.ro,i);BlockRead(b,NP0.l,i);BlockRead(b,NP0.Vrest,i);BlockRead(b,
    NV0.V,i);BlockRead(b,NV0.Im,i);BlockRead(b,NV0.IsynE,i);BlockRead(b,NV0.IsynI,i);BlockRead(b,NV0.IsynE_old,i);BlockRead(b,NV0.Vd,i);
//                                                            :vect2;
  Readln(vvv,
    NV0.gActive,
    NP0.C_membr,NP0.gNaR,NP0.gK,NP0.gKM,NP0.gKA,NP0.gKD,NP0.gCaH,NP0.gKCa,NP0.gAHP,NP0.gCaT,NP0.gBst,NP0.gNaP,
